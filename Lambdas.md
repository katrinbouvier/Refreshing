...
> Функциональные методы следует помечать аннотацией @FunctionalInterface. Компилятор в этом случае проверяет, что аннотируемый элемент является интерфейсом с единственным абстрактным методом. Также, страница документирующих комментариев является 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTYyMzc0MTU3NiwtMzg2MDA2MDA0XX0=
-->